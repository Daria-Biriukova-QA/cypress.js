describe('Покупка аватара', function () {                               // название набора тестов
   it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
        ...
        cy.get('input[type="email"]').type('какой-то логин');      // вводим логин
        cy.get('input[type="password"]').type('какой-то пароль');    // вводим пароль
        ...
        cy.get('.k_input_name').type('Alla Allova');                           // вводим имя владельца действия карты
